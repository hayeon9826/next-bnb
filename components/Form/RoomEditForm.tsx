      ...
      >
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          ...
          <button
            ...
            className="rounded-lg bg-rose-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600 disabled:bg-gray-300"
          >
            수정하기
          </button>
        </div>
